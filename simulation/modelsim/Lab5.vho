...
-- F	=>  Location: PIN_24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- S	=>  Location: PIN_28,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF \2to1MUX\ IS
...
-- Equation(s):
-- \inst1~0_combout\ = (\S~combout\ & ((\B~combout\))) # (!\S~combout\ & (\A~combout\))
